...
const uses: Record<Lang, UsesData> = {
  en: {
    ...
    hardware: [
      ...
      { name: "Secretlab Titan", description: "Comfortable for long coding sessions", url: "https://secretlab.eu/pages/titan-evo-2022-series" },
    ],
    software: [
      {
        category: "AI Tools",
  ...
  fr: {
    ...
    hardware: [
      ...
      { name: "Secretlab Titan", description: "Confortable pour les longues sessions de code", url: "https://secretlab.eu/pages/titan-evo-2022-series" },
    ],
    software: [
      {
        category: "Outils IA",
